...
Steps 0-1, 2-4, and 6 (plus both quick-fixes' first item) are implemented and retired — see
...
| [step-5-reliability-and-filtering-merge.md](step-5-reliability-and-filtering-merge.md) | Kill fabricated ATS score of 50; retries, `Retry` queue, `company_type` AI classification | Step 4 (done) | L |
...
- [`../refinement-plans/README.md`](../refinement-plans/README.md) — the 3 remaining plan
  docs (2 are retired; see `../CHANGELOG.md`).
