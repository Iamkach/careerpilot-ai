...
Spec: docs/backlog/step-15a-serve-bridge-scaffold.md (scaffold: /health, auth, CORS, bind).
      docs/backlog/step-15b-plan-endpoint-identify-job.md (/plan, /resume/meta).
      docs/backlog/step-15d-resume-attach.md (/resume bytes — this file's new cases).
